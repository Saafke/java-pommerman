...
public class Game {
    ...
    HashMap<Integer, ActionDistribution> actionDistributions = retrieveActionDistributions("hashMapRHEA.ser");
    ...
    private Types.RESULT[] terminate() {
        ...
        saveActionDistributions(actionDistributions, "hashMapRHEA.ser");
